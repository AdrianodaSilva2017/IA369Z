...
Abaixo, compara-se a imagem original com a imagem adequada.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{VerificationOfCompressionMethodForDicomImages_files/VerificationOfCompressionMethodForDicomImages_17_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
na linha de pixels que incrementa 20\% da linha inicial.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{VerificationOfCompressionMethodForDicomImages_files/VerificationOfCompressionMethodForDicomImages_19_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
comprimida JPEG.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{VerificationOfCompressionMethodForDicomImages_files/VerificationOfCompressionMethodForDicomImages_21_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
imagem no formato comprimido, podemos observar o histograma abaixo:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{VerificationOfCompressionMethodForDicomImages_files/VerificationOfCompressionMethodForDicomImages_24_0.png}
    \end{center}
    { \hspace*{\fill} \\}
